...
export interface ApiAboutAbout extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aboutPartner: Schema.Attribute.Component<'social.social-media', true> &
    ...
    learnMore: Schema.Attribute.Component<'btn-text.button-cta', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    ourCoreValue: Schema.Attribute.Component<
      'our-core-values.our-core-value',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    ourCoreValueTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    ourMission: Schema.Attribute.Component<'our-mission.our-mission', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ourVision: Schema.Attribute.Component<'our-mission.our-mission', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    clientSaysTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    meetOurLawyers: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    practiceAreaTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLawyerLawyer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adminTeams: Schema.Attribute.Relation<
      'manyToMany',
      'api::lawyers-team.lawyers-team'
    >;
    associateTeams: Schema.Attribute.Relation<
      'manyToMany',
      'api::lawyers-team.lawyers-team'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    partnersTeam: Schema.Attribute.Relation<
      'manyToMany',
      'api::lawyers-team.lawyers-team'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLawyersTeamLawyersTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adminTeams: Schema.Attribute.Relation<'manyToMany', 'api::lawyer.lawyer'>;
    associateTeam: Schema.Attribute.Relation<
      'manyToMany',
      'api::lawyer.lawyer'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    partnersTeams: Schema.Attribute.Relation<
      'manyToMany',
      'api::lawyer.lawyer'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPracticeAreasDetailPracticeAreasDetail
  extends Struct.CollectionTypeSchema {
  collectionName: 'practice_areas_details';
  info: {
    displayName: 'PracticeAreasDetails';
    pluralName: 'practice-areas-details';
    singularName: 'practice-areas-detail';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    commonCase: Schema.Attribute.Component<'common-case.common-case', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    commonCasetext: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    relatedServiceText: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
